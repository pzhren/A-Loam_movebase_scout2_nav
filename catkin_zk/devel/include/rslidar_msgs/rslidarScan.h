...
struct rslidarScan_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::rslidar_msgs::rslidarPacket_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rslidar_msgs::rslidarPacket_<ContainerAllocator> >> _packets_type;
