...
struct ScoutStatus_
{
  ...
  (void)_alloc;
      ...
      driver_states.assign( ::scout_msgs::ScoutDriverState_<ContainerAllocator> (_alloc));
  }
  ...
  _motor_states_type motor_states;
   ...
   typedef boost::array< ::scout_msgs::ScoutDriverState_<ContainerAllocator> , 4>  _driver_states_type;
...
struct Printer< ::scout_msgs::ScoutStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::scout_msgs::ScoutStatus_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.driver_states.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::scout_msgs::ScoutDriverState_<ContainerAllocator> >::stream(s, indent + "    ", v.driver_states[i]);
    }
